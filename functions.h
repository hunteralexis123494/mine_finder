...
/*THESE ARE THE FUNCTIONS I USED IN MY PROJECT.  YOU ARE NOT REQUIRED TO USE
...
// This function checks to see if an element is a mine. 
// If one is, it will be changed to -1.
void checkIfMine(int**, int**, int, int);

// This function checks neighbors of top-left corner to see if they are mines. 
// Element increments by one if neighbor is a mine.
void checkTopLeft(int**, int**, int, int);

// This function checks neighbors of bottom-left corner to see if they are mines. 
// Element increments by one if neighbor is a mine.
void checkBottomLeft(int**, int**, int, int);

// This function checks neighbors of top-right corner to see if they are mines. 
// Element increments by one if neighbor is a mine.
void  checkTopRight(int**, int**, int, int);

// This function checks the bottom-right neighbor to see if it is a mine.
// Element increments by one if neighbor is a mine.
void checkBottomRight(int**, int**, int, int);

// This function checks the left neighbor to see if it is a mine.
// Element increments by one if neighbor is a mine.
void checkLeft(int**, int**, int, int);

// This function checks the right neighbor to see if it is a mine.
// Element increments by one if neighbor is a mine.
void checkRight(int**, int**, int, int);

// This function checks the top neighbor to see if it is a mine.
// Element increments by one if neighbor is a mine.
void checkTop(int**, int**, int, int);

// This function checks the bottom neighbor to see if it is a mine.
// Element increments by one if neighbor is a mine.
void checkBottom(int**, int**, int, int);
